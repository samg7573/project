...
<body>
	...
	<center>
		...
		<form action="insertData.do" method="post">
			<table border="1" cellpadding="0" cellspacing="0">
				<tr>
					<td bgcolor="skyblue" size="20">운동파트</td>
					<td align="left"><select name="part">
							<option value="스트레칭">스트레칭</option>
							<option value="맨몸운동상체">맨몸운동-상체</option>
							<option value="맨몸운동하체">맨몸운동-하체</option>
							<option value="머신바벨운동상체">머신바벨운동-상체</option>
							<option value="머신바벨운동하체">머신바벨운동-하체</option>
					</select></td>
				</tr>

				<tr>
					<td bgcolor="skyblue" size="20">유튜버</td>
					<td align="left"><input name="youtuber" type="text" size="20"
						required /></td>

				</tr>

				<tr>
					<td bgcolor="skyblue" size="20">링크</td>
					<td align="left"><input name="link" type="text" size="20"
						required /></td>
				</tr>

				<tr>
					<td bgcolor="skyblue" size="20">프레임 링크</td>
					<td align="left"><textarea name="framelink" id="framelink"
							type="text" cols="20" rows="5" required></textarea></td>
				</tr>
