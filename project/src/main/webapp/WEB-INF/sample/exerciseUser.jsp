	...
	<div id="sh_wrapper">
		<div id="sh_hd">
			...
			<center>
				...
				<h3>Registering a Routine</h3>
				<br> <br> <br>
				<h2 style="font-size: 150%;">"자신만의 루틴을 입력하세요."</h2>
				<br> <br> <br>
				...
				<center>
					...
					<form name="form_insert" id="form_insert_id"
						...
						action="insertExInfo.do?userId=${loggedInUser.getId()}&routine=${routine}"
						method="post" onsubmit="return telecom_check()">
						<table style="text-align: center;">
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">제목</th>
								<td colspan="4"><input type="text" name="ttl" /></td>
							</tr>
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">운동
									유형</th>
								<td colspan="4"><select name="ctgry_e_str"
									style="width: 20%; font-size: 20px;" id="telecom"
									title="운동 카테고리선택">
										<option>----- 선택하세요 -----</option>
										<c:forEach var="catorylist" items="${CategoryList}"
											varStatus="status">
											<option
												value="${catorylist.e_ctgry_id},${catorylist.clsf_nm}"><c:out
													value="${catorylist.clsf_nm}" /></option>
										</c:forEach>
								</select></td>
							</tr>
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">공개여부</th>
								<td><input type='radio' name="prvt" font-size="20px"
									value=false checked="checked" /> 공개&nbsp;&nbsp;&nbsp; <input
									type='radio' name="prvt" font-size="20px" value=true /> 비공개</td>
								<th scope="col" style="text-align: center; font-weight: bold;">칼로리(kcal)</th>
								<td><input type="text" name="cal" /></td>
							</tr>
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">작성자</th>
								<td colspan="3"><input type="hidden" name="reg_user_str"
									value="${loggedInUser.id}"> <input type="text"
									disabled="disabled" value="${loggedInUser.nick_nm}"></td>
							</tr>
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">운동시간(min)</th>
								<td><input type="text" name="excr_tm" /></td>
								<th scope="col" style="text-align: center; font-weight: bold;">체중(kg)</th>
								<td><input type="text" name="wght" /></td>
							</tr>
							<tr>
								<th scope="col" style="text-align: center; font-weight: bold;">등록일</th>
								<td colspan="4"><input type="text" name="reg_dt_YMD"
									value="${LocalDate_YMD}" readonly="readonly">
							</tr>
						</table>
						<br>
