...
<script>
    $(document).ready(
        ...
        $("#signupButton").click(
              function() {
                 var eml_prefix = $("#eml_prefix").val();
                   var eml_suffix = $("#eml_suffix").val();
                   var eml_domain = $("select[name='eml_domain']").val();
                   if (eml_domain === "직접입력") {
                       eml_domain = $("#eml_custom_domain_input").val();
                   }
                   var eml = eml_prefix + "@" + eml_domain;
                    
                    
                    
               var sexdstn = $("select[name='sexdstn'] option:selected").text();
               var formData = {
                  user_nm : $("input[name='user_nm']").val(),
                  nick_nm : $("input[name='nick_nm']").val(),
                  user_id : $("input[name='user_id']").val(),
                  user_pswd : $("input[name='user_pswd']").val(),
                  sexdstn : sexdstn,
                  eml : eml,
                  mbr_grd : $("select[name='mbr_grd'] option:selected").val()
               };
               
               $.ajax({url : "insertUser.do",
                  method : "POST",
                  data : formData,
                  success : function(data) {
                           if (data != null) {
